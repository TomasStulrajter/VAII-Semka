        ...
        $(document).on('click', '#vyhodnot_tlacidlo', function() {
            ...
            $.ajax({
                ...
                success:function(response) {
                    ...
                    var hlaska4 = document.createElement('p');
                    var text4 = "Celková úspešnosť je " + (response.celkova_uspesnost.toString() * 100) + "%."
                    hlaska4.id = "hlaska_4";
                    hlaska4.innerText = text4;

                    obal.appendChild(hlaska1);
                    obal.appendChild(hlaska2);
                    obal.appendChild(hlaska3);
                    obal.appendChild(hlaska4);
